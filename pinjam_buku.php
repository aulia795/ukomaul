...
<html lang="en">
  ...
  <body>
     ...
     <div class="container">
        <div class="card" stlye="margin-top: 4rem;">
            <div class="row m-4">
              <?php
                ...
                <div class="col-sm-7">
                    ...
                    <form action="t_pinjam.php" method="POST">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" name="namapeminjam" class="form-control" required id="exampleInputEmail1" aria-describedby="emailHelp">
                        </div>
                        <div class="row">
                            <div class="col">
                                <div class="mb-3">
                            ...
                            <div class="col">
                                <div class="mb-3">
                                    ...
                                    <input type="date" name="tgl_pembelian" class="form-control" required id="exampleInputEmail1" aria-describedby="emailHelp">
                                </div>
                            </div>
                        </div>
                        <div class="mb-3">
